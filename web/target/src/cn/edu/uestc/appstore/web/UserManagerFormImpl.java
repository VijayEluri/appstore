...
public class UserManagerFormImpl
        ...
        , cn.edu.uestc.appstore.web.PopulateUserScreenForm
{
    ...
    public void setUserVOsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("UserManagerFormImpl.setUserVOsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("UserManagerFormImpl.setUserVOsBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setUserIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("UserManagerFormImpl.setUserIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("UserManagerFormImpl.setUserIdBackingList encountered an exception", ex);
            }
        }
    }
