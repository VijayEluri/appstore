    ...
    The project located in this directory has been generated by selerda
    ...
    that a model called 'appstore' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /appstore J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/selerda/.m2/repository/appstore/
