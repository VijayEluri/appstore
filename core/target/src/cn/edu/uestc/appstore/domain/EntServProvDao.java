 ...
 */
public interface EntServProvDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.EntServProv from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.EntServProv}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.EntServProv and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.EntServProv create(cn.edu.uestc.appstore.domain.EntServProv entServProv);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.EntServProv)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.EntServProv entServProv);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.EntServProv and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.EntServProv
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.EntServProv</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.lang.String, java.util.Date, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.lang.Integer)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.util.Date, java.lang.String, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>entServProv</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.EntServProv from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.EntServProv entServProv);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.EntServProv having the given
