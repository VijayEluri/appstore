 ...
 */
public interface PersonServProvDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.PersonServProv from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.PersonServProv}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.PersonServProv and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.PersonServProv create(cn.edu.uestc.appstore.domain.PersonServProv personServProv);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.PersonServProv)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.PersonServProv personServProv);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.PersonServProv and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.PersonServProv
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.PersonServProv</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.lang.String, java.util.Date, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.lang.Integer)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.util.Date)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>personServProv</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.PersonServProv from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.PersonServProv personServProv);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.PersonServProv having the given
