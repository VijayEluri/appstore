 ...
 */
public interface ComOrderItemDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.ComOrderItem from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.ComOrderItem}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.ComOrderItem and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.ComOrderItem create(cn.edu.uestc.appstore.domain.ComOrderItem comOrderItem);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.ComOrderItem)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.ComOrderItem comOrderItem);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.ComOrderItem and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.ComOrderItem
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.ComOrderItem</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.Integer, java.lang.Float, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.Integer, java.lang.Float)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>comOrderItem</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ComOrderItem from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.ComOrderItem comOrderItem);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ComOrderItem having the given
