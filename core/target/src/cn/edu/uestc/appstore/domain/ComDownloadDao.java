 ...
 */
public interface ComDownloadDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.ComDownload from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.ComDownload}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.ComDownload and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.ComDownload create(cn.edu.uestc.appstore.domain.ComDownload comDownload);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.ComDownload)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.ComDownload comDownload);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.ComDownload and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.ComDownload
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.ComDownload</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.util.Date, float)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.util.Date)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>comDownload</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ComDownload from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.ComDownload comDownload);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ComDownload having the given
