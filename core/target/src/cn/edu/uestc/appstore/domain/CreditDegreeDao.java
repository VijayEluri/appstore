 ...
 */
public interface CreditDegreeDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.CreditDegree from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.CreditDegree}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.CreditDegree and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.CreditDegree create(cn.edu.uestc.appstore.domain.CreditDegree creditDegree);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.CreditDegree)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.CreditDegree creditDegree);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.CreditDegree and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.CreditDegree
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.CreditDegree</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.Integer, java.lang.Integer)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>creditDegree</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.CreditDegree from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.CreditDegree creditDegree);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.CreditDegree having the given
