 ...
 */
public interface ResouceTestDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.ResouceTest from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.ResouceTest}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.ResouceTest and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.ResouceTest create(cn.edu.uestc.appstore.domain.ResouceTest resouceTest);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.ResouceTest)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.ResouceTest resouceTest);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.ResouceTest and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.ResouceTest
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.ResouceTest</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.util.Date, java.util.Date, java.lang.String, java.lang.String, java.lang.Integer, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.Integer, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>resouceTest</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ResouceTest from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.ResouceTest resouceTest);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ResouceTest having the given
