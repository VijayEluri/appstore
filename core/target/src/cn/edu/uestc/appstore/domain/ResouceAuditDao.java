 ...
 */
public interface ResouceAuditDao
{
    /**
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.ResouceAudit from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.ResouceAudit}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.ResouceAudit and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.ResouceAudit create(cn.edu.uestc.appstore.domain.ResouceAudit resouceAudit);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.ResouceAudit)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.ResouceAudit resouceAudit);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.ResouceAudit and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.ResouceAudit
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.ResouceAudit</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.util.Date, java.lang.String, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.util.Date, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>resouceAudit</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ResouceAudit from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.ResouceAudit resouceAudit);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.ResouceAudit having the given
