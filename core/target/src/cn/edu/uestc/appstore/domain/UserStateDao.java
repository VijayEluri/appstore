...
public interface UserStateDao
{
    ...
    /**
     * Loads an instance of cn.edu.uestc.appstore.domain.UserState from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link cn.edu.uestc.appstore.domain.UserState}.
     *
    ...
    /**
     * Creates an instance of cn.edu.uestc.appstore.domain.UserState and adds it to the persistent store.
     */
    public cn.edu.uestc.appstore.domain.UserState create(cn.edu.uestc.appstore.domain.UserState userState);

    /**
     * <p>
     * Does the same thing as {@link #create(cn.edu.uestc.appstore.domain.UserState)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, cn.edu.uestc.appstore.domain.UserState userState);

    /**
     * Creates a new instance of cn.edu.uestc.appstore.domain.UserState and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of cn.edu.uestc.appstore.domain.UserState
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>cn.edu.uestc.appstore.domain.UserState</code>
    ...
    /**
     * Updates the <code>userState</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.UserState from the persistent store.
     */
    public void remove(cn.edu.uestc.appstore.domain.UserState userState);

    /**
     * Removes the instance of cn.edu.uestc.appstore.domain.UserState having the given
